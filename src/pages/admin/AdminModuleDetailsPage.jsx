        ...
        <AdminLayout>
            <div>
                ...
                <div className="grid grid-cols-1 gap-4">
                        ...
                        <Card key={q.id} className="p-4">
                            <div className="flex justify-between items-start">
                                <div className="flex-1">
                                    ...
                                    {q.type === 'mcq' && (
                                        <ul className="text-sm text-gray-600 space-y-1">
                                            {q.options.map((opt, i) => (
                                                <li key={i} className={opt === q.correctAnswer ? 'text-emerald-600 font-semibold' : ''}>
                                ...
                                <div className="flex gap-2">
                                    <Button variant="secondary" size="sm" onClick={() => openModal(q)}>
                                        Edit
                                    </Button>
                    ...
                    {moduleQuestions.length === 0 && <p className="text-gray-500">No questions added yet.</p>}
                </div>
