...
const AdminReportsPage = () => {
  ...
  <AdminLayout>
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 text-sm sm:text-base">
            Comprehensive insights into course and student performance
          </p>
        </div>
      ...
      <Card className="p-6 mb-6 bg-white shadow rounded-lg">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm text-gray-600">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="px-6 py-3 uppercase tracking-wide">Student</th>
                <th className="px-6 py-3 uppercase tracking-wide">Course</th>
                <th className="px-6 py-3 uppercase tracking-wide">Score</th>
                <th className="px-6 py-3 uppercase tracking-wide">Date</th>
                <th className="px-6 py-3 uppercase tracking-wide">Violations</th>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {recentAttempts.map((attempt, idx) => {
                ...
                return (
                  <tr key={idx} className={attempt.violationCount > 0 ? "bg-red-50" : "hover:bg-gray-50"}>
                    ...
                    <td className="px-6 py-4 text-gray-900">{course?.title || 'Unknown Course'}</td>
                    <td className="px-6 py-4">
                      <div className="font-semibold">{attempt.score}/{attempt.totalMarks}</div>
                    ...
                    <td className="px-6 py-4">
                      {attempt.autoSubmitted ? (
                        <span className="px-2 py-1 bg-orange-100 text-orange-700 rounded-full text-xs font-semibold">Auto-Submitted</span>
                      ) : (
                        <span className="px-2 py-1 bg-green-100 text-green-700 rounded-full text-xs font-semibold">Normal</span>
                      )}
                    </td>
                  </tr>
                );
