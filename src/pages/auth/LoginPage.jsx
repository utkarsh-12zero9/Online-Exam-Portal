...
const LoginPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      const mockUser = {
        id: 1,
        name: formData.email.includes('admin') ? 'Admin User' : 'John Doe',
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-16">
            <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center">
              <span className="text-emerald-500 font-bold text-2xl">E</span>
            </div>
          ...
          <div className="max-w-md">
            ...
            <p className="text-emerald-100 text-lg leading-relaxed">
              Your comprehensive online examination platform. Take tests, track your progress, 
              and achieve your learning goals with our advanced proctoring and analytics system.
            </p>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              ...
              >
                <div className="text-emerald-700 font-semibold text-sm mb-1">User Demo</div>
                <div className="text-emerald-600 text-xs">user@test.com</div>
              </button>
              ...
              >
                <div className="text-blue-700 font-semibold text-sm mb-1">Admin Demo</div>
