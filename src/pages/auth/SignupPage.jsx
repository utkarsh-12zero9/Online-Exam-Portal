...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-blue-500 p-12 flex-col justify-between relative overflow-hidden">
        {/* Decorative Elements */}
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-16">
            <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center">
              <span className="text-blue-500 font-bold text-2xl"><Newspaper /></span>
            </div>
        ...
        <div className="relative z-10 space-y-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white text-lg">1000+ Courses Available</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
              <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span className="text-white text-lg">AI-Powered Proctoring</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
              <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span className="text-white text-lg">Instant Results & Analytics</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Sign up to get started with ExamPortal</p>
          </div>
            ...
            <div>
              <label className="flex items-start cursor-pointer">
                ...
                <span className="ml-2 text-sm text-gray-600">
                  I agree to the{' '}
                  <button type="button" className="text-blue-600 hover:underline">Terms & Conditions</button>
                  {' '}and{' '}
